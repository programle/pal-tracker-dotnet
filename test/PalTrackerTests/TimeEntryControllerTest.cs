...
namespace PalTrackerTests
{
    public class TimeEntryControllerTest
    {
        ...
        private readonly Mock<IOperationCounter<TimeEntry, TrackedOperation>> _operationTimeEntry;

        public TimeEntryControllerTest()
        {
            _repository = new Mock<ITimeEntryRepository>();
            _operationTimeEntry = new Mock<IOperationCounter<TimeEntry, TrackedOperation>>();
            _controller = new TimeEntryController(_repository.Object, _operationTimeEntry.Object);
            _operationTimeEntry.Setup(o => o.Increment(It.IsAny<TrackedOperation>()));
        }
        ...
        public void Read()
        {
            ...
            _operationTimeEntry.Verify(ot => ot.Increment(TrackedOperation.Read), Times.Once);
        }
        ...
        public void Create()
        {
            ...
            Assert.Equal(expected, typedResponse.Value);
            _operationTimeEntry.Verify(ot => ot.Increment(TrackedOperation.Create), Times.Once);
        }
        ...
        public void List()
        {
            ...
            Assert.Equal(200, typedResponse.StatusCode);
            _operationTimeEntry.Verify(ot => ot.Increment(TrackedOperation.List), Times.Once);
        }
        ...
        public void Update()
        {
            ...
            Assert.Equal(200, typedResponse.StatusCode);
            _operationTimeEntry.Verify(ot => ot.Increment(TrackedOperation.Update), Times.Once);
        }
